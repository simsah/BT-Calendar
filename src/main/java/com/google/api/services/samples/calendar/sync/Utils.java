...
public class Utils {
  ...
  private static final java.io.File DATA_STORE_DIR =
      new java.io.File(System.getProperty("/var/log/bt"), ".store/calendar-sync");
  /**
  ...
  public static Credential authorize(List<String> scopes) throws Exception {
    ...
    GoogleClientSecrets clientSecrets = GoogleClientSecrets.load(JSON_FACTORY,
        new InputStreamReader(Objects.requireNonNull(SyncTokenSample.class.getResourceAsStream("/client_secrets.json"))));
